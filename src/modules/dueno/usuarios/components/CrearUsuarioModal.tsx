...
import { User, Mail, Lock, X, Save, ShieldCheck, Sparkles } from 'lucide-react';
                                    ...
                                    >
                                        {saving ? (
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="uppercase tracking-widest text-xs">Registrando...</span>
                                            </div>
                                        ) : (
                                            <>
                                                <Save className="h-5 w-5" />
                                                <span className="uppercase tracking-widest text-xs">Crear Miembro</span>
                                            </>
                                        )}
                                    </motion.button>
